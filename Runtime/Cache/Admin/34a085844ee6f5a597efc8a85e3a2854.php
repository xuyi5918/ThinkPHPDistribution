...
<td style="text-align:center">
    ...
    <td style="text-align:center">
    	 <a href="__APP__/Admin/Order/HuiFu/id/<?php echo ($vo["id"]); ?>" class="btn btn-mini"><i class="icon-edit"></i> 恢复</a> 
         
          <a href="__APP__/Admin/Order/DeleteData/Id/<?php echo ($vo["id"]); ?>/cid/<?php echo ($_GET['id']); ?>" class="btn btn-mini"><i class="icon-edit"></i> 彻底删除</a> 
    </td>
