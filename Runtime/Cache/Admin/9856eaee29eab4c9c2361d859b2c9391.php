...
<div style="margin:0 auto; width:98%;">
	...
	<tbody>
		<tr>
			<th colspan="3" style="text-align:center;">修改用户</th>
			
		</tr>

		
	<form action="<?php echo U('UserSave');?>" method="post" name="form1" enctype="multipart/form-data">
		<?php if(is_array($SaveInfo)): $i = 0; $__LIST__ = $SaveInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			<td width="10%" style="text-align:center;">用户名：</th>
			
			<td width="30%">
			<input type='hidden' name='id' value='<?php echo ($vo["cid"]); ?>'/>
		...
		<tr>
			...
			<td><input type='text' name='Coompy' value='<?php echo ($vo["coompy"]); ?>'/>[<small style='color:red'>*</small>]</td>
		</tr>
		<tr>
			...
			<select name="level">
            	...
            	<option  value="<?php echo ($vo["level"]); ?>"><?php echo ($vo["vipname"]); ?></option>
				<?php if(is_array($LevelList)): $i = 0; $__LIST__ = $LevelList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ao): $mod = ($i % 2 );++$i;?><option  value="<?php echo ($ao["id"]); ?>"><?php echo ($ao["vipname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
	...
	<tr>
			...
			<td>
				<input type="text" name="xsg" value='<?php echo ($vo["xsg"]); ?>' id="Host" ><!--销售额-->
	...
	<tr>
			...
			<td>
				<input type="text" name="Cont" value='<?php echo ($vo["count"]); ?>' id="Host" ><!--总订单-->
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="pre" value='<?php echo ($vo["pay"]); ?>' id="Host" >
				[<small style='color:red'>元</small>]
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="jf" value='<?php echo ($vo["jf"]); ?>' id="Host" >
				[<small style='color:red'>积分</small>]
			</td>
		</tr>
		...
		<tr>
			...
			<td>
                ...
                <input type="text" name="wz" value='<?php echo ($vo["web"]); ?>' id="Host" >
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="phone" value='<?php echo ($vo["phone"]); ?>' id="Host" >
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="qq" value='<?php echo ($vo["qq"]); ?>' id="Host" >
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="address" value="<?php echo ($vo["address"]); ?>" id="Host" >
			</td>
		</tr>
	...
	<tr>
			...
			<td>
				...
				<input type="text" name="mail" value="<?php echo ($vo["maill"]); ?>"  />
		...
		<tr >
			...
			<td colspan="3"><button class="btn btn-large btn-info" type="submit">修改</button></td>
		</tr>
	</form>
	</tbody>
	</table>
