...
<?php if(is_array($list_cont)): $i = 0; $__LIST__ = $list_cont;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	<td height="26" align="right" class="bline" style="padding-left:10px; text-align:right"><font color="red">分类名称：</font></td>
	<td class="bline"><input name="ClassName" type="text" id="username" size="30" class="iptxt" value='<?php echo ($vo["name"]); ?>'></td>
</tr>
<tr>
	<td height="26" align="right" class="bline" style="padding-left:10px; text-align:right"><font color="red">分类排序：</font></td>
	<td class="bline"><input name="Sotr" type="text" id="name" size="30" class="iptxt" value='<?php echo ($vo["sort"]); ?>'></td>
</tr>
